...
modified_img_data , train_label = shuffle(modified_img_data,train_label)

# FITTING DATA INTO THE model

history = model.fit(modified_img_data, train_label , epochs=50 , validation_split=0.3 , shuffle=True,)
